    ...
    <PublicLayout>
      <main className="max-w-4xl mx-auto px-6 pt-16 pb-24">
        ...
        <section className="mb-16">
          <h2 className="text-h1 mb-4" style={{ color: 'var(--ds-text)' }}>Our Mission</h2>
        ...
        {/* Story */}
        <section className="mb-16">
          <h2 className="text-h1 mb-4" style={{ color: 'var(--ds-text)' }}>Our Story</h2>
          <p className="text-body mb-4" style={{ color: 'var(--ds-text2)' }}>
        ...
        {/* Values */}
        <section>
          <h2 className="text-h1 mb-6" style={{ color: 'var(--ds-text)' }}>Our Values</h2>
