    ...
    <PublicLayout>
      <main className="max-w-3xl mx-auto px-6 pt-16 pb-24">
        ...
        <div className="text-center mb-12">
          <h1 className="text-display mb-4" style={{ color: 'var(--ds-text)' }}>Terms of Service</h1>
        ...
        <div className="flex flex-col gap-10">
          ...
          <section>
            ...
            <ul className="flex flex-col gap-2 pl-5" style={{ listStyleType: 'disc' }}>
              <li className="text-body" style={{ color: 'var(--ds-text2)' }}>You must be at least 13 years old to use our service</li>
              <li className="text-body" style={{ color: 'var(--ds-text2)' }}>You are responsible for maintaining the security of your account</li>
              <li className="text-body" style={{ color: 'var(--ds-text2)' }}>You must not use our service for any illegal or unauthorized purpose</li>
              <li className="text-body" style={{ color: 'var(--ds-text2)' }}>You remain solely responsible for any code generated or modified using our service</li>
            </ul>
          </section>
