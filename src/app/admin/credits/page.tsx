...
export default function AdminCreditsPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        {statCards.map((stat) => {
          ...
          return (
            <div
              key={stat.id}
              className="bg-[#111411] border border-[#1F2B1F] rounded-[8px]-xl p-5"
            >
              <div className="flex items-center justify-between mb-3">
                <div className="w-10 h-10 rounded-[8px] flex items-center justify-center" style={{ backgroundColor: `${stat.color}15`, border: `1px solid ${stat.color}30` }}>
      ...
      <div className="bg-[#111411] border border-[#1F2B1F] rounded-[8px]-xl">
        {/* Header */}
          ...
          <div className="flex items-center gap-3">
            <div className="relative">
              ...
              <input
                ...
                className="w-64 pl-9 pr-3 py-2 bg-[#171C17] border border-[#283228] rounded-[8px] text-[#E8F5E9] placeholder-[#4D6B4D] text-sm focus:outline-none focus:border-[#00C853]"
              />
            </div>
            ...
            <select
              ...
              className="h-9 px-3 bg-[#171C17] border border-[#283228] rounded-[8px] text-[#E8F5E9] text-sm focus:outline-none focus:border-[#00C853]"
            >
      ...
      {showAdjustModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
          <div className="bg-[#111411] border border-[#1F2B1F] rounded-[8px]-xl w-full max-w-md p-6">
            ...
            <form onSubmit={handleManualAdjust} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full px-3 py-2 bg-[#171C17] border border-[#283228] rounded-[8px] text-[#E8F5E9] placeholder-[#4D6B4D] focus:outline-none focus:border-[#00C853]"
                />
              </div>
              ...
              <div className="flex items-center gap-3 pt-4">
                <button
                  ...
                  className="flex-1 h-10 px-4 rounded-[8px] bg-[#283228] text-[#E8F5E9] font-medium hover:bg-[#1F2B1F] transition-colors text-sm"
                >
                  Cancel
                </button>
                <button
                  type="submit"
                  disabled={adjusting}
                  className="flex-1 h-10 px-4 rounded-[8px] bg-[#00C853] text-black font-medium hover:bg-[#00E676] transition-colors text-sm disabled:opacity-50"
                >
