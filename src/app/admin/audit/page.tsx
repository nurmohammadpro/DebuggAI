  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <select
            ...
            className="h-10 px-4 bg-[#111411] border border-[#1F2B1F] rounded-lg text-[#E8F5E9] text-sm focus:outline-none focus:border-[#00C853]"
          >
      ...
      <div className="flex gap-4">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-[#171C17] border border-[#283228] rounded-lg text-[#E8F5E9] placeholder-[#4D6B4D] focus:outline-none focus:border-[#00C853]"
          />
        </div>
        ...
        <select
          ...
          className="h-10 w-40 px-3 bg-[#171C17] border border-[#283228] rounded-lg text-[#E8F5E9] text-sm focus:outline-none focus:border-[#00C853]"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-[#111411] border border-[#1F2B1F] rounded-xl p-4">
          ...
          <div className="divide-y divide-[#1F2B1F]">
            {filteredEvents.map((event) => {
              ...
              return (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-[#1E261E] flex items-center justify-center flex-shrink-0 border border-[#1F2B1F]">
