...
export default function AdminSettingsPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto">
      ...
      {/* Tabs */}
      <div className="flex items-center gap-1 p-1 bg-[#111411] border border-[#1F2B1F] rounded-[8px] w-fit">
        {tabs.map((tab) => {
          const Icon = tab.icon;
          return (
            <button
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          {activeTab === 'general' && (
            <>
              {/* Rate Limits */}
              <div className="bg-[#111411] border border-[#1F2B1F] rounded-[8px]-xl p-6">
                ...
                <div className="space-y-6">
                  {['free', 'pro', 'team', 'business'].map((plan) => (
                    <div key={plan} className="p-4 rounded-[8px] bg-[#171C17] border border-[#1F2B1F]">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div>
                          ...
                          <input
                            type="number"
                            className="w-full px-3 py-2 bg-[#111411] border border-[#283228] rounded-[8px] text-[#E8F5E9] focus:outline-none focus:border-[#00C853] transition-colors text-sm"
              ...
              <div className="bg-[#111411] border border-[#1F2B1F] rounded-[8px]-xl p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <select className="w-full px-3 py-2 bg-[#111411] border border-[#283228] rounded-[8px] text-[#E8F5E9] focus:outline-none focus:border-[#00C853] transition-colors text-sm">
          ...
          {activeTab === 'security' && (
            <div className="bg-[#111411] border border-[#1F2B1F] rounded-[8px]-xl p-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between p-4 bg-[#171C17] rounded-[8px] border border-[#1F2B1F]">
                  <div>
                ...
                <div className="flex items-center justify-between p-4 bg-[#171C17] rounded-[8px] border border-[#1F2B1F]">
                  ...
                  <select className="h-9 px-3 bg-[#111411] border border-[#283228] rounded-[8px] text-[#E8F5E9] text-sm focus:outline-none focus:border-[#00C853]">
            ...
            <div className="bg-[#111411] border border-[#1F2B1F] rounded-[8px]-xl p-6">
              ...
              <div className="space-y-4">
                {[
                  ...
                  <div key={setting.label} className="flex items-center justify-between p-4 bg-[#171C17] rounded-[8px] border border-[#1F2B1F]">
                    <div>
          ...
          {activeTab === 'integrations' && (
            <div className="bg-[#111411] border border-[#1F2B1F] rounded-[8px]-xl p-6">
              ...
              <div className="space-y-4">
                <div className="p-4 bg-[#171C17] rounded-[8px] border border-[#1F2B1F]">
                  ...
                  <input
                    type="password"
                    defaultValue="sk-••••••••••••••••"
                    className="w-full px-3 py-2 bg-[#111411] border border-[#283228] rounded-[8px] text-[#E8F5E9] text-sm focus:outline-none focus:border-[#00C853]"
                  />
                </div>
                <div className="p-4 bg-[#171C17] rounded-[8px] border border-[#1F2B1F]">
                  <div className="flex items-center justify-between mb-3">
