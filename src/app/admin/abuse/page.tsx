    ...
    <div className="space-y-4 max-w-[1600px] mx-auto">
      ...
      <div className="grid grid-cols-4 gap-4">
        {[
          ...
          <div
            key={stat.id}
            className={`bg-[#111411] border rounded-[8px]-xl p-4 cursor-pointer transition-transform hover:translate-y-[-2px] ${
                ...
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="inline-flex items-center gap-1 text-xs font-medium rounded-[8px] px-2 py-0.5 bg-[#FF5252]/15 text-[#FF5252]">
                        {violation.type}
                      </span>
                  ...
                  <div className="flex gap-2">
                    {violation.canLift && (
                      <button className="h-8 px-3 rounded-[8px] bg-transparent text-[#E8F5E9] border border-[#283228] hover:border-[#00C853] hover:text-[#00C853] transition-all text-xs font-medium">
                      Lift
                    </button>
                    )}
                    <button className="inline-flex items-center gap-1.5 h-8 px-3 rounded-[8px] bg-transparent text-[#FF5252] border border-[#FF5252]/35 hover:bg-[#FF5252]/10 transition-all text-xs font-medium">
