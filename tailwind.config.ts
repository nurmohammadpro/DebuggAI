...
const config: Config = {
  ...
  theme: {
    extend: {
      ...
      fontSize: {
        'display': ['32px', { lineHeight: '1.1', letterSpacing: '-0.5px', fontWeight: '600' }],
      ...
      boxShadow: {
        'ds-focus': '0 0 0 3px rgba(0,200,83,0.14)',
        'ds-focus-error': '0 0 0 3px rgba(255,82,82,0.14)',
        'ds-card': '0 4px 16px rgba(0,0,0,0.4)',
      },
    },
  },
  plugins: [],
